...
Dataset_names_path = "custom_dataset/license_plate_names.txt"
Dataset_train = "custom_dataset/license_plate_train.txt"
Dataset_test = "custom_dataset/license_plate_test.txt"
is_subfolder = False
